...
export const getRandomNumber = (max: number, min: number = 0) => Math.max(Math.floor(Math.random() * max), min)

export const getRandomMessage = () => messages[getRandomNumber(messages.length - 1)]
